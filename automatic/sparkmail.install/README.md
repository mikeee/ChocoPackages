# ![Sparkmail Logo](https://cdn.jsdelivr.net/gh/mikeee/ChocoPackages/icons/sparkmail.png "sparkmail Logo") [sparkmail.install](https://chocolatey.org/packages/sparkmail.install)
