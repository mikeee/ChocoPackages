# ![komodo-ide Logo](https://cdn.jsdelivr.net/gh/mikeee/ChocoPackages/icons/komodo-ide.png "Komodo IDE Logo") [komodo-ide](https://chocolatey.org/packages/komodo-ide)
