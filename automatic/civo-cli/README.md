# ![civo-cli Logo](https://cdn.jsdelivr.net/gh/mikeee/ChocoPackages/icons/civo-cli.png "civo-cli Portable Logo") [civo-cli](https://chocolatey.org/packages/civo-cli)
