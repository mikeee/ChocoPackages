...
$packageArgs = @{
    ...
    url64            = 'https://github.com/bostrot/wsl2-distro-manager/releases/download/v2.0.2/wsl2-distro-manager-v2.0.2.zip'
    checksum64       = '4ce0271418e39a3a1ff26308abbe0f2410b6f3faa9cdcde312c5f1729025d483'
