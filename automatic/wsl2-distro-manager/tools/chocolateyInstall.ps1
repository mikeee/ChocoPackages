...
$packageArgs = @{
    ...
    url64            = 'https://github.com/bostrot/wsl2-distro-manager/releases/download/v2.1.0/wsl2-distro-manager-v2.1.0.zip'
    checksum64       = 'd492eb491c2aad0bdc02de21e1336ef12e5d32e284f25a409ae6e37f34ff11ce'
