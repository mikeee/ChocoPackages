...
$packageArgs = @{
    ...
    url            = 'https://github.com//pawelsalawa/sqlitestudio/releases/download/3.3.0/sqlitestudio-3.3.0.zip'
    checksum       = 'c0e078d2fd8d67fe27ae0720145e09a69371bc3ff19ceb75ef489539f652eae2'
    checksumType   = 'SHA256'
