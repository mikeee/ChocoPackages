...
$packageArgs = @{
    ...
    url            = 'https://github.com//pawelsalawa/sqlitestudio/releases/download/3.3.1/sqlitestudio-3.3.1.zip'
    checksum       = 'af793500546b3e3ff96b963fffdafd50a3327bf050ede81df50cc845e71bce5d'
    checksumType   = 'SHA256'
